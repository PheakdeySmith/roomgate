        ...
        <div class="col-xl-4 col-lg-5 col-md-6">
            <div class="card overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                ...
                <form action="https://coderthemes.com/boron/layouts/index.html" class="text-start mb-3">
                    ...
                    <p class="mb-0 text-center">Don't received code yet? <a href="https://coderthemes.com/boron/layouts/auth-confirm-mail.html#!" class="link-primary fw-semibold text-decoration-underline">Send Again</a></p>
                </form>
