                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('plan_group') is-invalid @enderror" id="plan_group" name="plan_group" value="{{ old('plan_group') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('base_monthly_price') is-invalid @enderror" id="base_monthly_price" name="base_monthly_price" value="{{ old('base_monthly_price') }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('duration_days') is-invalid @enderror" id="duration_days" name="duration_days" required>
                                        ...
                                        <option value="0" {{ old('duration_days') == 0 ? 'selected' : '' }}>Lifetime</option>
                                    </select>
                                    @error('duration_days')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('properties_limit') is-invalid @enderror" id="properties_limit" name="properties_limit" value="{{ old('properties_limit', 1) }}" required min="1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('rooms_limit') is-invalid @enderror" id="rooms_limit" name="rooms_limit" value="{{ old('rooms_limit', 10) }}" required min="1">
                                    @error('rooms_limit')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
