    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form id="createRoomForm" method="POST" action="{{ route('landlord.properties.rooms.store', ['property' => $property->id]) }}">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="floor" name="floor" placeholder="e.g. 1, 2">
                        </div>
